        ...
        switch (whichbonk) {
            case 0:
                const bonk1embed = new Discord.MessageEmbed()
                    .setAuthor('Bonk and Scout Wedding Photo')
            ...
            case 1:
                const bonk2embed = new Discord.MessageEmbed()
                    .setAuthor('Bonk and Scout going home after the wedding')
                    .setURL('https://youtu.be/kuNixp-wvWM')
					.setColor("BLURPLE")
            ...
            case 2:
                const bonk3embed = new Discord.MessageEmbed()
                    .setAuthor('Scout seeing Bonk for the first time')
                    .setURL('https://youtu.be/kuNixp-wvWM')
					.setColor("BLURPLE")
            ...
            case 3:
                const bonk4embed = new Discord.MessageEmbed()
                    .setAuthor('Scout and Bonk laughing at Sniper')
                    .setURL('https://youtu.be/kuNixp-wvWM')
					.setColor("BLURPLE")
			...
			case 4:
                const bonk5embed = new Discord.MessageEmbed()
                    .setAuthor('Bonk defending her newbord child')
                    .setURL('https://youtu.be/kuNixp-wvWM')
					.setColor("BLURPLE")
			...
			case 5:
                const bonk6embed = new Discord.MessageEmbed()
                    .setAuthor('Bonk stopping Scout from beating up the RED Scout')
                    .setURL('https://youtu.be/kuNixp-wvWM')
					.setColor("BLURPLE")
			...
			case 6:
                const bonk7embed = new Discord.MessageEmbed()
                    .setAuthor('In terms of home, they have no home... for now.')
                    .setURL('https://youtu.be/kuNixp-wvWM')
					.setColor("BLURPLE")
